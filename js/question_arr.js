var t = [
    ...
    },
    {
        ...
        risposte: [
            ...
            "Consistency: Con le transazioni solo i dati validi venno salvati",
        ...
        corretta: ["Atomicity: Le transazioni devono essere atomiche", "Consistency: Con le transazioni solo i dati validi venno salvati",
            "Isolation: Le transazioni non interferiscono tra di loro in caso di concorrenza (più transazioni eseguite nello stesso momento sugli stessi elementi)",
            "Durability: Nelle transazioni dopo il COMMIT i dati scritti non verranno persi"
        ]
    },
    ...
    },
    {
        ...
        corretta: "Crea una relazione one to many tra due colonne di due tabelle diverse, viene inserita nella parte many"
    },
    {
    ...
    },
    {
        ...
        risposte: [
            "Determina il modo in cui i dati venno fisicamente ordinati all'interno della tabella nel DB, posso dichiararne solo uno all'interno di una tabella",
            "Genera una tabella di lookup, con un ordine diverso rispetto alla tabella, che velocizza le operazioni di lettura. Posso dichiararne n all'interno di una tabella",
            "Genera dei puntatori all'interno della tabella"
        ],
